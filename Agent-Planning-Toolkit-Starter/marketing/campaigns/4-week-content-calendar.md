...
This calendar follows a manageable weekly cadence:
...
- Reuse existing proof artefacts.
- Keep each post outcome-first.
- End each primary post with one clear CTA.

## Week 1: Launch the positioning

### Week 1 LinkedIn (1)

Topic: Operator-led, outcome-first delivery with AI-accelerated execution and visible governance.

CTA: Reply `PLAN` for repo link.
...
Topic: Claim-to-proof index and why it matters for trust.

CTA: Comment `PROOF` for index link.
...
Topic: Non-coding but commercially savvy founders, common pain points and outcomes.

CTA: Reply `CLARITY` for planning session format.
...
Topic: What a client leaves with after a planning sprint.

CTA: Reply `SPRINT` for scope and next step.
...
1. Log results in `campaign-iteration-log-template.md`.
2. Record one message that resonated.
3. Record one message to retire.
4. Choose next week's lead proof artefact.
